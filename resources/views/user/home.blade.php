            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <div class="single-wid-product">
                            <a href="single-product.html"><img src="{{asset('user/img/product-thumb-1.jpg')}}" alt="" class="product-thumb"></a>
                        ...
                        <div class="single-wid-product">
                            <a href="single-product.html"><img src="{{asset('user/img/product-thumb-2.jpg')}}" alt="" class="product-thumb"></a>
                        ...
                        <div class="single-wid-product">
                            <a href="single-product.html"><img src="{{asset('user/img/product-thumb-3.jpg')}}" alt="" class="product-thumb"></a>
                ...
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <a href="#" class="wid-view-more">View All</a>
                        <div class="single-wid-product">
                            <a href="single-product.html"><img src="{{asset('user/img/product-thumb-4.jpg')}}" alt="" class="product-thumb"></a>
